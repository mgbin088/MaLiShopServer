        ...
        with app.app_context():
            for i in l:
                ...
                if os.path.isfile(path):
                    a=os.system('sh /www/wwwroot/cdn.maliapi.cn/silk-v3-decoder-master/converter.sh %s mp3'%path)
                    db.query("update post_future set tomp3=1,mp3=%s where id=%s",[mp3,id])
                else:
                    db.query("update post_future set tomp3=2 where id=%s", id)
